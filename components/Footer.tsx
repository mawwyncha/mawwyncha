    ...
    <footer className="bg-black text-white py-12 px-6">
      <div className="container mx-auto max-w-5xl flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-center md:text-left">
          <h2 className="pixel-font text-xl mb-2">LET'S CONNECT!</h2>
          <p className="text-gray-400 retro-font text-xl">Open for opportunities in AI, Localization & Design.</p>
        </div>
        
        <div className="flex flex-wrap justify-center gap-4">
          <a href="mailto:maulida.dc@gmail.com" className="bg-white text-black p-3 hover:bg-pink-300 transition-colors">
          ...
          <a href="#" className="bg-white text-black p-3 hover:bg-blue-300 transition-colors">
          ...
          <a href="#" className="bg-white text-black p-3 hover:bg-purple-300 transition-colors">
      ...
      <div className="mt-12 text-center text-[10px] pixel-font text-gray-600">
        © 2025 MAULIDA DWI CAHYANI. POWERED BY PIXELS & PASSION.
      </div>
    </footer>
  );
};
